...
[![Build status](https://img.shields.io/github/actions/workflow/status/hagelstam/accountant-bot/main.yml?branch=main)](https://github.com/hagelstam/accountant-bot/actions/workflows/main.yml?query=branch%3Amain)
